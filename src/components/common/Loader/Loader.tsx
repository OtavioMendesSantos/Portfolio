    ...
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" height="200" width="200">
        <g style={{ order: "-1" }}>
          ...
          />
          <defs>
            <linearGradient y2="100%" x2="10%" y1="0%" x1="0%" className={styles.gradiente}>
              <stop
          ...
          />
          <defs>
            <linearGradient y2="100%" x2="10%" y1="0%" x1="0%" className={styles.gradiente3}>
              <stop
                style={{ stopColor: "#d3a51000", stopOpacity: "1" }}
                offset="20%"
              />
